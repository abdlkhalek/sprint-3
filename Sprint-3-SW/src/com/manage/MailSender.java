...
//	private DataConnector mails ;
//	private DataConnector sms ;
	 ...
	 *  @throws SQLException
	 */
	public MailSender() throws ClassNotFoundException, SQLException{
	...
	public boolean send( String notificationType) throws SQLException {
		if (MailConnector.types.contains(notificationType)) {
				data.quarry = "DELETE FROM mails WHERE subject=?";
